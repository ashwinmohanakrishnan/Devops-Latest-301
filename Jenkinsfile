      ...
      server.upload(uploadSpec)
        ...
        stage('Deploy War to Tomcat') {
 	                steps{
                        ...
                        sh "ssh ubuntulogin@ugkrx73290dns.EastUS2.cloudapp.azure.com 'sudo fuser -k -n tcp 8080'"
                        sh "ssh ubuntulogin@ugkrx73290dns.EastUS2.cloudapp.azure.com 'echo -ne '\n' | nohop java -jar /home/ubuntulogin/Docker/*.jar &'"
 	        }
 	}
